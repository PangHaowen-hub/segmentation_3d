...
def setup_logger(logpth):
    logfile = 'UNet_RUL-{}.log'.format(time.strftime('%Y-%m-%d-%H-%M-%S'))  # TODO:改log名
...
def train(model):
    ...
    train_dataset = MyDataset(rootpth="./data", mode='train/after/RUL')  # TODO：改数据地址
    ...
    for epoch in range(args.num_epochs):
        ...
        torch.save(model.state_dict(), 'UNet_RUL%d.pth' % epoch)  # TODO:改pth名
