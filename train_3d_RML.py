...
def setup_logger(logpth):
    logfile = 'UNet3d-RML-{}.log'.format(time.strftime('%Y-%m-%d-%H-%M-%S'))
...
def train(model):
    ...
    for epoch in range(args.num_epochs):
        ...
        torch.save(model.state_dict(), './UNet3d_RML/UNet3d_RML_%d.pth' % epoch)
        if epoch % 10 == 0:
            source_test_dir = r'./data_3d/test/RM/img'
            save_path = r'./data_3d/test/RM/pred_right_unet3d'
            ...
            pred_path = r'./data_3d/test/RM/pred_right_unet3d'
